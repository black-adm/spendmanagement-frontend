...
export function HomeSection() {
  return (
    <div className="grid gap-x-4 gap-y-8 sm:grid-cols-2 md:gap-x-6 lg:grid-cols-3 xl:grid-cols-4">
      <div className="bg-gradient-to-l from-slate-900 to-black pb-5 rounded-lg">
        <span className="group relative mb-2 block h-96 overflow-hidden rounded-t-lg bg-gray-100 shadow-lg lg:mb-3">
          <img
      ...
      <div className="bg-gradient-to-l from-slate-900 to-black pb-5 rounded-lg">
        ...
        <div className="flex items-start justify-between gap-2 px-4">
          <div className="flex flex-col">
            ...
            <span className="text-white text-sm">
              Acompanhe compras no seu cartão.
            </span>
          </div>
          <div className="flex flex-col items-end">
            <span className="font-bold text-primary-green lg:text-lg">
