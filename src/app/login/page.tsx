                ...
                <div className="flex flex-1 flex-col items-center justify-center px-10 pt-2 relative">
                    <div className="flex lg:hidden justify-between items-center w-full py-4">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="lucide lucide-plus"><path d="M5 12h14"/><path d="M12 5v14"/></svg>
                                Criar uma conta
                            </a>
                        </div>
                    </div>
